...
export default {
  ...
  head() {
    return {
      title: `Juri Miyazawa Portfolio | ${this.currentProject.title.full}`,
      meta: [
        { hid: 'og:title', property: 'og:title', content: `Juri Miyazawa Portfolio | ${this.currentProject.title.full}` },
      ]
    }
  },
