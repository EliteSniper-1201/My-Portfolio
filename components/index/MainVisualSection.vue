      ...
      <div class="l-container">
        <h1 class="hero-title">
          <span class="hero-title-read-area">
            <AppReadTitle :state="isTextSegmentState" :text="['・', 'AUTHOR : JURI MIYAZAWA', 'FRAMEWORK : VUE/NUXT', 'LIBRARY : GSAP/THREE.JS', 'CMS : MICROCMS']" :modifier="'section'" />
          </span>
          <span class="pc-only">
            <span class="hero-title-wrapper hero-title-wrapper-01">
              ...
              <AppTextAnimation :state="isTextSegmentState" :rotate="$BASEROTATE.right" :text="'FOLIO OF JURI MIYAZAWA'" :sp-animation="false" />
            </span>
          ...
          <span class="sp-only">
            ...
            <span class="hero-title-wrapper hero-title-wrapper-02-sp">
              ...
              <AppTextAnimation :state="isTextSegmentState" :start="0.176" :rotate="$BASEROTATE.left" :text="'JURI MIYAZAWA'" :pc-animation="false" />
            </span>
