        ...
        <h1 ref="HeroTitle" class="hero-title">
          ...
          <span class="pc-only">
            ...
            <span class="hero-title-wrapper hero-title-wrapper-02">
              ...
              <AppTextAnimation :state="isTextSegmentState" :start="0.176" :rotate="$BASEROTATE.left" :text="'JURI'" :sp-animation="false" />
              <AppTextAnimation :state="isTextSegmentState" :start="0.4" :rotate="$BASEROTATE.left" :text="'MIYAZAWA'" :sp-animation="false" />
            </span>
          ...
          <span class="sp-only">
            ...
            <span class="hero-title-wrapper hero-title-wrapper-02-sp">
              ...
              <AppTextAnimation :state="isTextSegmentState" :start="0.176" :rotate="$BASEROTATE.left" :text="'JURI'" :pc-animation="false" />
              <AppTextAnimation :state="isTextSegmentState" :start="0.4" :rotate="$BASEROTATE.left" :text="'MIYAZAWA'" :pc-animation="false" />
            </span>
